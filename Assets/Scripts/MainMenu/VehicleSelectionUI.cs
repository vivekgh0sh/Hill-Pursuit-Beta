// --- START OF FILE VehicleSelectionUI.cs (REVISED FOR TUNE BUTTON) ---
...
public class VehicleSelectionUI : MonoBehaviour
{
    ...
    [SerializeField] private Button tuneButton; // --- ADD THIS ---
    ...
    void Start()
    {
        ...
        tuneButton.onClick.AddListener(GoToTuneScreen); // --- ADD THIS ---
    ...
    void GoToTuneScreen()
    {
        // GameManager already knows the selected car index, so we just load the scene.
        SceneManager.LoadScene("TuneUI");
    }
    ...
    public void StartGame() { GameManager.Instance.SaveGameData(); SceneManager.LoadScene("endless"); }
